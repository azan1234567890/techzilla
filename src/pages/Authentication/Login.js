...
const Login = (props) => {
    ...
    // Add global event listener to check for Enter key press
    useEffect(() => {
    ...
    document.title = "SignIn | AI ENHANCE";

    return (
        <React.Fragment>
            <ParticlesAuth>
                <div className="auth-page-content" style={{paddingBottom: '8px',minHeight:'100vh', overflowY:'auto', alignItems: 'center', display: 'flex'}}>
                    <Container>
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mb-4 text-white-50" style={{paddingTop: '10px'}}>
                                    <div>
