...
const Register = () => {
    ...
    return (
        <React.Fragment>
            <ParticlesAuth>
            <div className="auth-page-content d-flex align-items-center min-vh-100 pb-2 custom-overflow-y-auto">
                    <Container>
                        <Row>
                            <Col lg={12}>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the AI ENHANCE
