...
const BasicSignUp = () => {
    ...
    return (
        <React.Fragment>
            <ParticlesAuth>
                 <div className="auth-page-content" style={{ overflowY: 'auto' }}>
                    <Container>
                        <Row>
                            <Col lg={12}>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form onSubmit={validation.handleSubmit} className="needs-validation" action="#">
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the AI Enhance  <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                </div>
