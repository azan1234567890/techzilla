...
//import images
// import logoAI from '../../../assets/images/logoAI.webp';
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    <Label htmlFor="email" className="form-label form-label">Email address</Label>
                                                    <Input type="email" name='email' className="form-control form-control" id="email" placeholder="Your email address" aria-invalid= 'false' />
                                                </div>
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <Label className="form-label form-label" htmlFor="password-input">Your Password</Label>
